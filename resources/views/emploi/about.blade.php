@extends('emploi.base')
  ...
  <div class="row">
  	<div class="col-md-12">
		...
		<p> You can find the github repository of this web application <a href="https://github.com/guinslym/cityjobs"  target="_blank">here (django app)</a> and <a href="https://github.com/guinslym/phpcityjobs"  target="_blank">here (Laravel app)</a>.  This present Laravel application is does not offer the French translation of the job description you have to click on the Download button to have the French and English version in a JSON format. Howerver the <a href="https://github.com/guinslym/cityjobs"  target="_blank">hDjango</a> app have both translation. This project is inpired from <a href="http://www.ottawacityjobs.ca/"  target="_blank">OttawaCityJobs</a></p>
